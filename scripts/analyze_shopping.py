"""Quick summary stats for data/shopping_centers_raw/shopping_centers_master.csv.

Usage: python scripts/analyze_shopping.py
"""
...
CSV_PATH = REPO_ROOT / "data" / "shopping_centers_raw" / "shopping_centers_master.csv"
...
def main() -> int:
    ...
    print("\nCategory alternate (top 20):")
    for cat, c in Counter(r["category_alternate"] or "?" for r in rows).most_common(20):
        print(f"  {cat:34} {c}")
