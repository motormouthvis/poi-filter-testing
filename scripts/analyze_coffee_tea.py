"""Quick summary stats for data/coffee_tea_raw/coffee_tea_master.csv.

Usage: python scripts/analyze_coffee_tea.py
"""
...
CSV_PATH = REPO_ROOT / "data" / "coffee_tea_raw" / "coffee_tea_master.csv"
...
def main() -> int:
    ...
    print("\nCategory primary (top 12):")
    for cat, c in Counter(r["category_primary"] or "?" for r in rows).most_common(12):
        print(f"  {cat:22} {c}")
